...
//	public final static String TPL_RESUME_INTERVIEW = "你收到来自%s公司的面试邀请，请准时参加。";
...
//	public final static String TPL_SALARY_GET = "您在【%s】工作的%s工资已到账，请登录查看账户余额。";
	public final static String TPL_SALARY_GET = "您在【%s】工作的%s月工资：%s元 已由公司财务确认，稍后将为您放款，请留意后续通知。";
	public final static String TPL_SALARY_OUT = "您在【%s】工作的%s月工资：%s元 已发放，请注意查收。";
