...
public class Student {
    ...
    public enum SchoolType {
    	ENGINEERINGCOLLEGE_NINE_EIGHT_FIVE,
    	ENGINEERINGCOLLEGE_TWO_ONE_ONE,
    	DOMESTIC,
    	OVERSEAS;
        
        public static SchoolType fromString(String str) {
            return Enum.valueOf(SchoolType.class, str.toUpperCase());
        }
		
		public String toChsString() {
			switch (this) {
			case ENGINEERINGCOLLEGE_NINE_EIGHT_FIVE:
				return "985工程学院";
			case ENGINEERINGCOLLEGE_TWO_ONE_ONE:
				return "211工程学院";
			case DOMESTIC:
				return "国内学院";
			case OVERSEAS:
    ...
    private String localResume;

    public String getLocalResume() {
		return localResume;
	}

	public void setLocalResume(String localResume) {
