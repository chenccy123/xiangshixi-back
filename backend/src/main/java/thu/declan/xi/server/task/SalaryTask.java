...
//            s.setMonth(format.format(ndaysBefore(1))); // 设置日期
            s.setMonth(format.format(WorkingDaysUtils.getLastMonthFirstDay())); // 因为是00:00:00 进行数据生成 此时月份已++ 所以要获取上月时间
