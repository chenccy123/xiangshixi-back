...
public class Constant {
	...
	public static final String UPLOAD_STU_RESUME = "/opt/web/upload/resumes";
...
//	public static final boolean EMAIL_USESSL = false;
    ...
    /*------------- wechat info -------------*/
    public static final String WECHAT_OPEN_APPID = "wx44895bec275b61e6"; // 商户账号appid
    ...
    public static final String WECHAT_MCH_ID = "1452897002"; // 商户号
